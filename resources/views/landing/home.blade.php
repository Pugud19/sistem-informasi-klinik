...
<div class="page-section">
      ...
      <div class="row">
        <div class="col-lg-4">
          <div class="card-service wow fadeInUp">
            <div class="header">
              <img src="landing/img/services/service-1.svg" alt="">
            </div>
            <div class="body">
        ...
        <div class="col-lg-4">
          <div class="card-service wow fadeInUp">
            <div class="header">
              <img src="landing/img/services/service-2.svg" alt="">
            </div>
            <div class="body">
        ...
        <div class="col-lg-4">
          <div class="card-service wow fadeInUp">
            <div class="header">
              <img src="landing/img/services/service-3.svg" alt="">
            </div>
            <div class="body">
  ...
  <div class="page-section banner-seo-check">
    <div class="wrap bg-image" style="background-image: url(landing/img/bg_pattern.svg);">
